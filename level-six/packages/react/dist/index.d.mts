...
declare const StitchesBox: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
type BoxProps = ComponentProps<typeof StitchesBox> & {
    as?: ElementType;
};
declare function Box({ children, ...props }: BoxProps): react_jsx_runtime.JSX.Element;

declare const StitchesText: _stitches_react_types_styled_component.StyledComponent<"p", {
...
type TextProps = ComponentProps<typeof StitchesText> & {
    as?: ElementType;
};
declare function Text({ children, ...rest }: TextProps): react_jsx_runtime.JSX.Element;
