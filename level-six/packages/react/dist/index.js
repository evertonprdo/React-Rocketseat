...
function Box(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StitchesBox, __spreadProps(__spreadValues({}, props), { children }));
}

// src/components/Text.tsx
var import_jsx_runtime2 = require("react/jsx-runtime");
var StitchesText = styled("p", {
  fontFamily: "$default",
  lineHeight: "$base",
  margin: 0,
  color: "$gray100",
...
function Text(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StitchesText, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function MultiStep({ size, currentStep = 1 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(MultiStepContainer, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Steps, { css: { "--steps-size": size }, children: Array.from({ length: size }, (_, step) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Step, { active: currentStep >= step + 1 }, step)) })
  ] });
}
