...
function Box(_a) {
  ...
  return /* @__PURE__ */ jsx(StitchesBox, __spreadProps(__spreadValues({}, props), { children }));
}
...
function Text(_a) {
  ...
  return /* @__PURE__ */ jsx2(StitchesText, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function MultiStep({ size, currentStep = 1 }) {
  return /* @__PURE__ */ jsxs3(MultiStepContainer, { children: [
    ...
    /* @__PURE__ */ jsx6(Steps, { css: { "--steps-size": size }, children: Array.from({ length: size }, (_, step) => /* @__PURE__ */ jsx6(Step, { active: currentStep >= step + 1 }, step)) })
  ] });
}
export {
  Avatar2 as Avatar,
